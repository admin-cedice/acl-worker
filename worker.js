...
TRATADOS Y CONVENIOS INTERNACIONALES (actualizado 23 ago 2026): cualquier tratado, convenio o convención internacional —bilateral o multilateral, de cualquier organismo (OIT, ONU, OEA, etc.)— es SIEMPRE ADMISIBLE. Esta instrucción ANULA POR COMPLETO, para este tipo de documento, tanto la pregunta de PERTINENCIA de arriba como la de ALCANCE GEOGRÁFICO — ninguna de las dos te corresponde evaluar aquí. NO evalúes si Venezuela lo suscribió, lo ratificó, lo está tramitando, o siquiera es miembro del organismo que lo emitió — esa decisión es del ciudadano que sube el documento, no tuya. Si identificas el documento como un tratado o convenio internacional (vigente, en trámite, o incluso un modelo/plantilla sin firmar por nadie todavía), responde "VEREDICTO: ADMISIBLE" — sin excepción, y sin usar MOTIVO: no_pertinente ni MOTIVO: fuera_de_alcance_geografico para este tipo de documento bajo ninguna circunstancia.`;
...
async function enviarEmailRechazo(email, motivo) {
  const cuerpos = {
    ...
    no_pertinente: `<p>Hola,</p>
         <p>Revisamos el documento que subiste a Auditoría Cívica Liberal. No pudimos admitirlo porque no corresponde al tipo de documento que auditamos — el Test de Libertad está diseñado para leyes, decretos, reglamentos, proyectos de ley, tratados y convenios internacionales, y políticas públicas, no para otro tipo de material.</p>
         <p>Si crees que esto es un error, escríbenos desde <a href="https://liberalmente.app/#contacto">nuestro formulario de contacto</a>.</p>
         <p style="font-size:12px;color:#888">Auditoría Cívica Liberal · <a href="https://liberalmente.app">liberalmente.app</a></p>`,
