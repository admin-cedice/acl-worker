    ...
    ideas: {
      ...
      items: {
        ...
        properties: {
          ...
          categoria: {
            type: 'string',
            enum: ['redes_sociales', 'carta', 'foro', 'monitoreo', 'medios'],
            description: 'El canal principal de esta acción: redes_sociales (campañas digitales, hashtags), carta (peticiones o cartas formales a autoridades), foro (reuniones, foros comunitarios, charlas presenciales o en vivo), monitoreo (seguimiento, transparencia, recolección de datos), medios (video, contenido audiovisual, prensa).',
          },
        },
